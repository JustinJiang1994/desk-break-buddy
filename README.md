...
[![Version](https://img.shields.io/badge/version-1.0.0-orange)](https://github.com/JustinJiang1994/desk-break-buddy)

**桌面休息伙伴**（项目代码名：desk-break-buddy）通过定时提醒功能，帮助长时间使用电脑的用户规律起身活动和补充水分，缓解久坐疲劳，养成健康的办公习惯。
...
- ⏰ **自定义计时器** - 创建任意数量的个性化提醒，灵活设置提醒间隔（无上限限制）
